  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text(
          'Hasil Penilaian Sebaya', // Title disesuaikan
          style: TextStyle(
            color: Colors.white,
            fontSize: 24.sp,
        ...
        SingleChildScrollView(
          ...
          child: ClipRRect(
            ...
            child: DataTable(
              ...
              dataRowHeight: 38.h, // Ganti dari dataRowMinHeight ke dataRowHeight
              headingRowColor: MaterialStateProperty.all(
                const Color(0xFFC49C75), // header coklat
              ),
              dataRowColor: MaterialStateProperty.all(
                const Color(0xFFF8F6E9), // isi cream
              ),
              border: TableBorder.all(
                color: const Color(0xFFDFCFB5), // coklat tua untuk garis pembatas
                width: 1.w,
              ),
              columns: const [
                DataColumn(
